  ...
  return (
    <div className="container mt-5">
      <div className="row text-center">
        ...
        <div className="col-4 p-3 mt-5">
          <img src="media/images/streakLogo.png" style={{width:"27%"}}/>
        ...
        <div className="col-4 p-3 mt-5 mb-3">
          <img src="media/images/zerodhaFundhouse.png" style={{width:"33%"}} />
        ...
        <div className="col-4 p-3 mt-5">
          <img src="media/images/dittoLogo.png" style={{width:"22%"}}/>
